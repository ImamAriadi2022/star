...
function createCampaign()
{
    ...
    $sql = "INSERT INTO campaigns (name, category, start_date, end_date, proposal_deadline, brief, brand_id) VALUES ('$name', '$category', '$start_date', '$end_date', '$proposal_deadline', '$brief', '$brand_id')";
